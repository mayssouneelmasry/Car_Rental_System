...
<style>
    body {
        background-image: url("http://localhost/CarRentalSystem/cartoon1.jpg");
...
.report-table tbody tr:nth-of-type(even) {
    background-color: white; /* Keeping even rows white */
}
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group" style="padding-left: 50px">
                                <labelclass="highlight-label"><strong>From Date</strong></label>
                                <input type="date" name="from_date" value="<?php if(isset($_GET['from_date'])){ echo $_GET['from_date']; } ?>" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group"  style="padding-left: 50px">
                                <labelclass="highlight-label"><strong>To Date</strong></label>
