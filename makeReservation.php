...
$sql = "INSERT INTO reservation (customerID, plateID, pickupDate, returnDate, totalPrice, isPickedUp, isReturned, isPaid) VALUES ('$customerID', '$plateID', '$pickupDate', '$returnDate', '$total', 0, 0, 0)";
if ($conn->query($sql) === TRUE) {
    header("Location: customerReservations.php");
} else {
    echo "Error: " . $conn->error; // Improved error message
}
?>